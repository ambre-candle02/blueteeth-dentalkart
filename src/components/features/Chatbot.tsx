            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="fixed bottom-[100px] md:bottom-8 right-4 md:right-6 w-14 h-14 bg-brand-primary text-white rounded-full flex items-center justify-center shadow-2xl hover:bg-brand-dark transition-colors z-50 group hover:scale-110 active:scale-95"
                    >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-4 right-4 md:bottom-6 md:right-6 w-[calc(100%-2rem)] sm:w-[400px] h-[600px] max-h-[85vh] bg-white rounded-3xl shadow-2xl border border-slate-100 flex flex-col overflow-hidden z-[100]"
                    >
                        {/* Header */}
